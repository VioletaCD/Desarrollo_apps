...
$"Matricula: {Matricula,6} Nombre: {Nombre,-18} Domicilio: {Domicilio,-15} Municipio: {Municipio,-10} Sexo: {(Sexo=='H'?"Hombre":"Mujer"),-8} Becado: {(Becado?"Becado":"No Becado"),-10} Califs: {string.Join(",",Califs)}";
}